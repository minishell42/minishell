...
void test_get_command_line()
{
	...
	t_cmd_line _case5 = {"echo", "-n", "1234 1234"};
	flag = 0;
	...
	t_cmd_line _case6 = {"echo", "-n", "1234 1234"};
	flag = 0;
	...
	t_cmd_line _case7 = {"echo", "-n", "1234 1234"};
	flag = 0;
	...
	// char *case9= "echo \" -n\" 1234 1234"; 
	// t_cmd_line _case9 = {"echo", "-n", "1234 1234"};
	// flag = 0;
